...
main()
{
    ...
    then
        ...
        vcs import thirdparty < fastrtps.repos
    fi
    ...
    # Build and install Fast DDS-Gen
    cd ${SCRIPT_DIR}/thirdparty/fastddsgen
    ./gradlew assemble
    cp share/fastddsgen/java/fastddsgen.jar ${SCRIPT_DIR}/${INSTALL_PREFIX}/lib
    cp scripts/fastddsgen ${SCRIPT_DIR}/${INSTALL_PREFIX}/bin/
    cd -
